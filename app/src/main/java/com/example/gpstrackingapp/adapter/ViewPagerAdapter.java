package com.example.gpstrackingapp.adapter;
...
public class ViewPagerAdapter extends PagerAdapter {
    ...
    private Integer[] images = {R.drawable.welcome_slider4, R.drawable.welcome_slider5, R.drawable.welcome_slider6};
    private String[] title = {"Find a Way", "Navigate with Confidence","Your Journey, Always in Sight!"};
